...
if (-not (Test-Path -LiteralPath $VENV_PY)) { Write-Host "PYTHON MISSING: $VENV_PY" -ForegroundColor Red; exit 1 }
...
if ($Wait) {
    Write-Host "Stack running. Keeping terminal session alive..." -ForegroundColor Cyan
    while ($true) {
