...
- Name: shots.pw.ts >> Viewport 1920x1080 >> /investigation — no overflow, no errors, attribution readable
- Location: scripts\shots.pw.ts:58:7

# Error details

```
Error: [1920x1080] /investigation: attribution element not found
